...
const Card = (props) => {
  return (
    <div
      className="card d-flex gap-1 flex-column rounded-4 p-3 shadow m-auto my-3"
      style={{ width: props.width, minWidth: "250px" }}
    >
      ...
      <div className="card__course__price align-self-end fw-bold">
        {props.price}
      </div>
    </div>
  );
